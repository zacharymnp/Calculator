 ...
 * @since 2019-12-13
 */
public class CalculatorMath extends JPanel implements ActionListener {
	...
	/**
	 * This is the main method, which creates CalculatorMathFrame and adds in the buttons
	 * @param args
	 * @return Nothing
	 */
	...
	JFrame CalculatorMathFrame = new JFrame();
	CalculatorMathFrame.getContentPane().add(CalculatorMath);
	CalculatorMathFrame.setSize(416, 599);
	CalculatorMathFrame.setVisible(true);
	CalculatorMathFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	CalculatorMathFrame.setResizable(false);
	CalculatorMath.setLayout(null); //we may want to use a layout, so that we don't need to worry about absolute positioning
	
	equalsButton.addActionListener(CalculatorMath);
	CalculatorMath.add(equalsButton);
	equalsButton.setBounds(200, 450, 100, 110);
	deleteButton.addActionListener(CalculatorMath);
	CalculatorMath.add(deleteButton);
	deleteButton.setBounds(300, 50, 100, 70);
	oneButton.addActionListener(CalculatorMath);
	CalculatorMath.add(oneButton);
	oneButton.setBounds(0, 340, 100, 110);
	twoButton.addActionListener(CalculatorMath);
	CalculatorMath.add(twoButton);
	twoButton.setBounds(100, 340, 100, 110);
	threeButton.addActionListener(CalculatorMath);
	CalculatorMath.add(threeButton);
	threeButton.setBounds(200, 340, 100, 110);
	fourButton.addActionListener(CalculatorMath);
	CalculatorMath.add(fourButton);
	fourButton.setBounds(0, 230, 100, 110);
	fiveButton.addActionListener(CalculatorMath);
	CalculatorMath.add(fiveButton);
	fiveButton.setBounds(100, 230, 100, 110);
	sixButton.addActionListener(CalculatorMath);
	CalculatorMath.add(sixButton);
	sixButton.setBounds(200, 230, 100, 110);
	sevenButton.addActionListener(CalculatorMath);
	CalculatorMath.add(sevenButton);
	sevenButton.setBounds(0, 120, 100, 110);
	eightButton.addActionListener(CalculatorMath);
	CalculatorMath.add(eightButton);
	eightButton.setBounds(100, 120, 100, 110);
	nineButton.addActionListener(CalculatorMath);
	CalculatorMath.add(nineButton);
	nineButton.setBounds(200, 120, 100, 110);
	zeroButton.addActionListener(CalculatorMath);
	CalculatorMath.add(zeroButton);
	zeroButton.setBounds(100, 450, 100, 110);
	pointButton.addActionListener(CalculatorMath);
	CalculatorMath.add(pointButton);
	pointButton.setBounds(0, 450, 100, 110);
	plusButton.addActionListener(CalculatorMath);
	CalculatorMath.add(plusButton);
	plusButton.setBounds(300, 450, 100, 110);
	minusButton.addActionListener(CalculatorMath);
	CalculatorMath.add(minusButton);
	minusButton.setBounds(300, 340, 100, 110);
	timesButton.addActionListener(CalculatorMath);
	CalculatorMath.add(timesButton);
	timesButton.setBounds(300, 230, 100, 110);
	dividedByButton.addActionListener(CalculatorMath);
	CalculatorMath.add(dividedByButton);
	dividedByButton.setBounds(300, 120, 100, 110);
	additionalFunctionsButton.addActionListener(CalculatorMath);
	CalculatorMath.add(additionalFunctionsButton);
	additionalFunctionsButton.setBounds(0, 0, 416, 50);
	leftParenthesisButton.addActionListener(CalculatorMath);
	CalculatorMath.add(leftParenthesisButton);
	leftParenthesisButton.setBounds(0, 340, 100, 110);
	rightParenthesisButton.addActionListener(CalculatorMath);
	CalculatorMath.add(rightParenthesisButton);
	rightParenthesisButton.setBounds(100, 340, 100, 110);
	exponentButton.addActionListener(CalculatorMath);
	CalculatorMath.add(exponentButton);
	exponentButton.setBounds(200, 340, 100, 110);
	squareRootButton.addActionListener(CalculatorMath);
	CalculatorMath.add(squareRootButton);
	squareRootButton.setBounds(100, 450, 100, 110);
	naturalLogButton.addActionListener(CalculatorMath);
	CalculatorMath.add(naturalLogButton);
	naturalLogButton.setBounds(100, 230, 100, 110);
	logButton.addActionListener(CalculatorMath);
	CalculatorMath.add(logButton);
	logButton.setBounds(0, 230, 100, 110);
	factorialButton.addActionListener(CalculatorMath);
	CalculatorMath.add(factorialButton);
	factorialButton.setBounds(200, 230, 100, 110);
	sineButton.addActionListener(CalculatorMath);
	CalculatorMath.add(sineButton);
	sineButton.setBounds(0, 120, 100, 110);
	cosineButton.addActionListener(CalculatorMath);
	CalculatorMath.add(cosineButton);
	cosineButton.setBounds(100, 120, 100, 110);
	tangentButton.addActionListener(CalculatorMath);
	CalculatorMath.add(tangentButton);
